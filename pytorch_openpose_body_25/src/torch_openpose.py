...
from pytorch_openpose_body_25.src import util
from pytorch_openpose_body_25.src.model import bodypose_model,bodypose_25_model

model_coco = 'pytorch_openpose_body_25/model/body_coco.pth'
model_body25 = 'pytorch_openpose_body_25/model/body_25.pth'
